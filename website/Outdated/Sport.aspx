<%@ Page Title="Sport" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Sport.aspx.cs" Inherits="Sport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <h1> Stiri Sport</h1>
       <br />
         <a href ="Sport.aspx?q=Data">Sorteaza dupa Data ascendent</a><br />
       <a href ="Sport.aspx?q=Data1">Sorteaza dupa Data descendent</a><br />
       <a href ="Sport.aspx?q=Titlu">Sorteaza dupa Titlu</a>
