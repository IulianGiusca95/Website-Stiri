<%@ Page Title="Adauga" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AddNews.aspx.cs" Inherits="AddNews" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:TextBox ID="TBDescriere" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
